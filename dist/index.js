...
const Button = (_a) => {
    ...
    return (React.createElement("button", Object.assign({ className: clsx.clsx(baseStyles, variantStyles[variant], sizeStyles[size], fullWidth && 'w-full', className) }, props), children));
};
...
const Card = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: clsx.clsx(baseStyles, backgroundStyles, hoverStyles, className) }, props), children));
};
...
const Gradient = (_a) => {
    ...
    if (asText) {
        return (React.createElement("span", Object.assign({ className: clsx.clsx('bg-clip-text text-transparent', className), style: {
                backgroundImage: gradients[variant],
            } }, props), children));
    }
    return (React.createElement("div", Object.assign({ className: clsx.clsx(className), style: {
            backgroundImage: gradients[variant],
        } }, props), children));
};
